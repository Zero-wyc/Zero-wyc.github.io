...
3. ### 设置 `IPCPassword`
   ...
   1. 刚才的操作进行完后，启动容器，访问`设备ip:1242`,看看能不能进入网页

   2. 如果可以的话，那么应该会出现这样的页面

      1. ![image-20260613101428857](https://github.cdn.zero251.xyz/Zero-wyc/Image/main/All/20260613101429056.webp)

   3. 回到`config`目录，添加一个`ASF.json`文件，并输入以下内容(`IPCPassword`为asf的登录密码，自行设置)
...
https://www.cnblogs.com/lightmon5210/p/19880178

https://www.bing.com/ck/a?!&&p=78ff793d6bb82465be7f7d592180b8bf4e088e2d88c92bcd24ea7c382c68d1fcJmltdHM9MTc4MTIyMjQwMA&ptn=3&ver=2&hsh=4&fclid=3043fa8e-ed87-67c1-3e13-edc7ec5566e8&u=a1aHR0cHM6Ly96aHVhbmxhbi56aGlodS5jb20vcC8xOTMxMTE5NjY5MDUxMzY0NTM4&ntb=1
